<footer>
        <div class="section-footer plan-site">
            ...
            <div class="links-footer-container">
                <a class="link-footer btn-blue" href="./index.php">Accueil</a>
                <a class="link-footer btn-green" href="./livres.php">Livres</a>
                <a class="link-footer btn-blue" href="./categories.php">Genre</a>
                <a class="link-footer btn-green" href="./contact.php">Contact</a>
            </div>
        </div>
