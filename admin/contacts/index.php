...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <a href="http://localhost:8888/projet_bibliotheque_clone/admin/contacts/add.php" class="btn btn-success">Ajouter un contact</a>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">ID</th>
            ...
            <tbody>
                ...
                <?php foreach ($contacts as $contact): ?>
                    <tr>
                        ...
                        <td><a href="http://localhost:8888/projet_bibliotheque_clone/admin/contacts/update.php?id=<?= $contact[
                            'id'
                        ] ?>" class="btn btn-warning">Modifier</a></td>
                        <td><a href="http://localhost:8888/projet_bibliotheque_clone/admin/contacts/action.php?id=<?= $contact[
                            'id'
