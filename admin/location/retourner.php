...
?>
<div class="container">
<h1 class="text-center mt-5">Retour de: <?=$livre['titre']?></h1>
...
<form action="<?= URL_ADMIN ?>location/action.php" method="POST" class="mb-5">
    ...
    <br>
    <input type="submit" class="btn btn-success mt-5" name="retourner_livre" value="Retourner">
